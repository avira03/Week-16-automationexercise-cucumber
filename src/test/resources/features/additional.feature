...
#Test Case 6: Contact Us Form
  Scenario: User should log the contact us form
    ...
    And I enter "shilpa" name to name field
...
#  Test Case 10: Verify Subscription in home page
  Scenario: User should verify the subscription in home page
    ...
    And I enter email address in input "shilpa@gmail.com"
...
#  Test Case 24: Download Invoice after purchase order
  Scenario: User should Download Invoice after purchase order
    ...
    And I fill all details in signup page "Mrs" "shilpa@123" "09" "August" "1988" "shilpa" "sharma" "28,SanskarDip fla" "Vastrapur" "India" "Gujarat" "Gujarat" "380015" "9879796999"
