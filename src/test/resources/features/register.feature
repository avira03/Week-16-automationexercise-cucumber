...
Feature: As a user,
  ...
  Scenario: User should register successfully
    ...
    And I send name "shilpa" and email "krish" to signup
    And I click on button "Signup"
    Then I should see text "ENTER ACCOUNT INFORMATION"
    And I fill all details in signup page "Mrs" "shilpa@123" "09" "August" "1988" "shilpa" "sharma" "28,SanskarDip fla" "Vastrapur" "India" "Gujarat" "Ahmedabad" "380015" "9879796999"
    ...
    Then I should see the text "Logged in as " "shilpa"
  ...
  Scenario: User should see error message while register with existing email
    When I click on header menu option Signup "Signup / Login"
    Then I should see the login page text "New User Signup!"
    And I send name "shilpa" to name field in signup
    And I send email "shilpa@gmail.com" to email field in signup
...
#  Test Case 14: Place Order: Register while Checkout
  Scenario: User should place the order : Register while checkout
    ...
    And I enter payment details "shilpa sharma" "429333344440000" "311" "04" and "2027"
